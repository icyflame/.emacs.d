...
"
  ...
  (with-current-buffer new-buffer
	...
	(setq does-previous-line-allow-delete-indentation nil)
	(setq line-number 0)
	...
	(while (not (eq (point-at-eol) (point-max)))
	  ...
	  (if is-line-empty (setq does-previous-line-allow-delete-indentation nil)
		...
		(if (and
			 ...
			 (not is-line-empty)
			 (eq does-previous-line-allow-delete-indentation t))
			(delete-indentation))
		(if (and (not is-block-begin) (not is-header-line)) (setq does-previous-line-allow-delete-indentation t))
